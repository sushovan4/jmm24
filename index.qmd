...
author: "<green><b>Sushovan Majhi</b></green><br><i>Assistant Professor, Data Science</i><br><green>George Washington University, Washington D.C., USA</green>"
...
Window size $=30$ and embedding dimension $=2$.
...
- Go to embedding dimension: <green>$7$</green>
- Window size: <green>$30$</green> (delay: $\tau=1$)
...
## Onset and Withdrawal of Monsoon {.smaller} 
...
- For a working early-warning system, we need a better resolution of the transition period 
  
- Enhance interpretability

- Instead of relying on delay coordinates, use more than just one singal
  
- Fine-tune the parameters (e.g. window size, embedding dimension, delay)
